...
def build_and_saved_model(Model_class, config, checkpoint_path, export_path):
    ...
    trans_model_save_path = export_path
    ...
    outputs = {
        ...
        "pred_ids": tf.saved_model.utils.build_tensor_info(model.pred_ids)
    }
    ...
    builder.add_meta_graph_and_variables(
        ...
        signature_def_map={
            tf.saved_model.signature_constants.DEFAULT_SERVING_SIGNATURE_DEF_KEY:ner_signature_def
        }
    )
